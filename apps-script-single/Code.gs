...
var LAEMU_INDEX_HTML = [
  ...
  "",
  "/* Auf schmalen Geräten steht jedes Eingabefeld auf einer eigenen Zeile.",
  "   Native Datums- und Zeitfelder haben eine Mindestbreite, die sich nicht",
  "   unterschreiten lässt – nebeneinander würden sie sonst ineinanderlaufen. */",
  ".times {",
  "  display: grid;",
  ...
  "}",
  "",
  "/* Ab 560 px ist Platz für Beginn, Ende und Stunden in einer Zeile. */",
